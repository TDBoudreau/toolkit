...
var jsonTests = []struct {
	...
	{name: "allow unknown fields", json: `{"fooo": "1"}`, errorExpected: false, maxSize: 1024, allowUnknown: true},
...
// TestTools_ReadJSON is a test function that verifies the behavior of JSON reading functionality in the application.
...
// TestTools_WriteJSON tests the WriteJSON method of the Tools type by writing a JSON response and verifying no errors occur.
...
// TestTools_ErrorJSON tests the ErrorJSON method to ensure it correctly encodes an error into a JSON response.
